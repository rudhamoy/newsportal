...
function VisualStoriesItem({ image, title, index, styles }) {
    return (
        <div style={styles} index={index} className={`h-[300px] w-[187px] p-2 relative rounded overflow-hidden cursor-pointer `}>
            ...
            <p className="absolute z-[1] bottom-4 left-0 text-white font-bold text-[10px] p-2 drop-shadow-3xl ">AUGUEST 5, 2022</p>
            <p className="absolute z-[1] bottom-[4px] left-0 text-[#daa634] font-bold text-[10px] p-2 drop-shadow-3xl ">CELEBRITY</p>
